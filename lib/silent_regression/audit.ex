defmodule SilentRegression.Audit do
  ...
  @metadata_keys_by_action %{
    ...
    "monitor.created" => [],
    "guided_setup.created" => ~w(recipe recipe_version revision),
    "guided_setup.saved" => ~w(recipe recipe_version revision),
    "guided_setup.proof_reviewed" => ~w(recipe recipe_version revision fingerprint),
    "guided_setup.sealed" => ~w(recipe recipe_version revision monitor_id fingerprint),
    ...
    "provider_credential.replacement_activated" =>
      ~w(provider predecessor_id affected_monitor_count requested_model_count reference_replacement_count),
