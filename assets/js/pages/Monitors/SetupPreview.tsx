    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-6xl space-y-6 px-5 py-7 sm:px-8 sm:py-10">
        ...
        {selecting ? <Panel title="Set the scene before you begin" description="Choose the output shape and the situation you want to walk through. These choices control fictional results for this design review—not the outcome of a real monitor.">
          ...
          <p className="mt-4 text-sm"><Link className="underline underline-offset-4" href={`/app/${workspaceSlug}/setup-drafts/new`}>Start a separate real monitor setup</Link> · choose routing, JSON, sources or text in Step 0. No preview data transfers.</p>
          ...
          {draft.step === 0 && <Panel title="Start with the request, not a rule editor" description="This fixed example keeps practice focused. Real provider selection, encrypted keys, editable messages and native templates are available in the separate saved setup—not in this simulation.">
